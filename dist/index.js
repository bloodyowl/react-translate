(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-translate"] = factory();
	else
		root["react-translate"] = factory();
})(this, function() {
	  ...
	  return function (ChildComponent) {
	    return (function (_Component) {
	      ...
	      function Translator() {
	        ...
	        _get(Object.getPrototypeOf(Translator.prototype), "constructor", this).apply(this, arguments);
	      }

	      _createClass(Translator, [{
	        key: "render",
	        value: function render() {
	          var t = this.context.translator.createComponentTranslator(displayName);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createTranslator = __webpack_require__(160);
	...
	var TranslatorProvider = (function (_Component) {
	  ...
	  function TranslatorProvider() {
	    ...
	    _get(Object.getPrototypeOf(TranslatorProvider.prototype), "constructor", this).apply(this, arguments);
	  }
	  ...
	  _createClass(TranslatorProvider, [{
	    ...
	    value: function render() {
	      if (typeof this.props.children !== "function") {
	        throw new Error("TranslatorProvider must have a single, function child");
	      }
...
/***/ function(module, exports) {
	...
	var Translator = (function () {
	  ...
	  function Translator(keys) {
	    ...
	    this.keys = keys;
	    this.pluralType = Translator.pluralTypes[pluralMap[keys.locale.slice(0, 2)]];
	  ...
	  _createClass(Translator, [{
	    key: "createComponentTranslator",
	    value: function createComponentTranslator(componentName) {
	      var _this = this;
	      ...
	      var keys = this.keys[componentName];
	      return function (key, params) {
	        var value = keys[key];
	        if (value === undefined) {
	          return componentName + "." + key;
	        ...
	        var replace = function replace(string) {
	          return string.replace(/\{{2}(\w+)\}{2}/g, function (whole, $1) {
	            return params[$1];
	          });
	        };
	        ...
	        if (Array.isArray(value)) {
	          if (params.n !== undefined) {
	            value = value[_this.pluralType(params.n)];
	          } else {
